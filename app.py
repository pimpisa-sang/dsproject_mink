...
if page == "Homepage":
    ...
    st.image("https://png.pngtree.com/background/20210714/original/pngtree-abstract-digital-background-big-data-visualization-network-connection-structure-science-background-picture-image_1249999.jpg", caption="Your Amazing Banner Image", use_column_width=True)
    st.write("""
